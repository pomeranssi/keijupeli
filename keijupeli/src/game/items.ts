...
const items: Array<Category> = [
    {
        ...
        items: [
            ...
            { img: 'bg-beach.jpg', left: 0, top: 0, className: 'default' },
    ...
    },
    {
        ...
        type: 'body',
        items: [
            { img: 'girl-white.png', left: 336, top: 198, className: 'default' },
    ...
    },
    {
        ...
        type: 'eyes',
        items: [
            { img: 'eyes-blue.png', left: 419, top: 310, className: 'default' },
    ...
    },
    {
        ...
        type: 'hair',
        items: [
            { img: 'hair-orig.png', left: 335, top: 150, className: 'default' },
    ...
    },
    {
        ...
        type: 'shoes',
        items: [
            { img: 'shoes-blue.png', left: 373, top: 888, className: 'default' },
